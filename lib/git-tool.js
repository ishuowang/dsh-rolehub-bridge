...
export function createGitReadTool(options = {}) {
    ...
    return defineTool({
        ...
        description: 'Read repository status, diffs, commit history, or one commit through a fixed non-mutating git interface. '
...
function runGit(args, cwd, signal, maxOutputBytes, timeoutMs) {
...
function rejectFields(input, fields) {
