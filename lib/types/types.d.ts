import type { CapabilityId, CatalogRole, LoadedRole, RoleCatalog } from '@ishuowang/rolehub-core';
...
export declare const SESSION_BINDING_SCHEMA_VERSION = 1;
export declare const ROLEHUB_PROVIDER_PREFIX = "rolehub-bridge-";
...
export declare const HOST_TOOL_BINDINGS: Readonly<Partial<Record<CapabilityId, readonly string[]>>>;
